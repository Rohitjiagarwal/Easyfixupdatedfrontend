          ...
          <div className="breadcrumb-content border">
            <div className="breadcrumb-content-item">
              <h2 className="fw-semibold display-5 text-center">
                Washing Machine{" "}
                <span className="gradient-text">Service in </span>
              </h2>
              <nav
                style={
            ...
            <div className="col-md-6">
              <div className="p-3 p-md-5 custom-bg custom-border-radius">
                ...
                <h2 className="fw-bold display-5 section-subtitle">
                  <span className="gradient-text">Washing Machine</span> Service
                  center
                </h2>
                <p>
                  Are you facing issues with your washing machine? Whether it’s
                  a minor repair, routine maintenance, or a major breakdown, we
                  are here to provide expert solutions for all your washing
                  machine needs. Our skilled technicians offer top-notch washing
                  machine repair, installation, and servicing for both
      ...
      <section className="brands-we-service my-9">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <h2 className="fw-bold display-5 section-subtitle">
              Washing Machine <span className="gradient-text">Brands</span> We
              Service
            </h2>
          ...
          <div className="row g-6">
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="lg-washing-machine-service-centre.html">
                  <img
            ...
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="samsung-washing-machine-service-centre.html">
                  <img
            ...
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="onida-washing-machine-service-centre.html">
                  <img
                    src="images/album/brands/onida-logo.png"
                    width="100%"
                    height="100%"
                    alt="onida Washing Machine service center"
                  />{" "}
                </a>
                <a
                  className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
            ...
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="panasonic-washing-machine-service-centre.html">
                  <img
                    src="images/album/brands/panasonic-logo.webp"
                    width="100%"
                    height="100%"
                    alt="panasonoic Washing Machine service center"
                  />{" "}
                </a>
                <a
                  className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
            ...
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="haier-washing-machine-service-centre.html">
                  <img
                    src="images/album/brands/Haier.svg"
                    width="100%"
                    height="100%"
                    alt="haier Washing Machine service center"
                  />{" "}
                </a>
                <a
                  className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
            ...
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="whirlpool-washing-machine-service-centre.html">
                  <img
                    src="images/album/brands/whirlpool.svg"
                    width="100%"
                    height="100%"
                    alt="whirlpool Washing Machine service center"
                  />{" "}
                </a>
                <a
                  className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
            ...
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="godrej-washing-machine-service-centre.html">
                  <img
                    src="images/album/brands/godrej.svg"
                    width="100%"
                    height="100%"
                    alt="godrej Washing Machine service center"
                  />{" "}
                </a>
                <a
                  className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
            ...
            <div className="col-6 col-md-3">
              <div className="brand-service">
                <a href="ifb-washing-machine-service-centre.html">
                  <img
                    src="images/album/brands/ifb-logo.svg"
                    width="100%"
                    height="100%"
                    alt="IFB Washing Machine service center"
                  />{" "}
                </a>
                <a
                  className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
            ...
            <div className="col-6 offset-md-4 col-md-3">
              <div className="brand-service">
                <a href="bosch-washing-machine-service-centre.html">
                  <img
                    src="images/album/brands/bosch.svg"
                    width="100%"
                    height="100%"
                    alt="Bosch Washing Machine service center"
                  />{" "}
                </a>
                <a
                  className="m-0 text-center w-100 mt-3 d-block custom-bg rounded-pill p-2 text-decoration-none"
      ...
      <section className="our-service-includes my-9">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="text-custom-light">
              At EasyFix Expert, we offer a full range of professional Washing
              Machine services to ensure your home or business stays cool and
              comfortable throughout the year. From installation and repairs to
              routine maintenance, our expert technicians are equipped to handle
              all your washing machine needs. No matter the brand or model, we
              deliver fast, reliable, and affordable service.
            </p>
          </div>
            ...
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Washing Machine Repair</h6>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Maintenance & Tune-ups</h6>
                </div>
              </div>
            </div>
            <div className="col">
            ...
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Emergency Services</h6>
                </div>
              </div>
            </div>
            <div className="col">
            ...
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Dry servicing</h6>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Replacement of Tub</h6>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Replacement of motor</h6>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Repairing circuits</h6>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Replacement of capacitors</h6>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h6 className="card-title m-0">Washing Machine Cleaning</h6>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="text-custom-light">
              ...
              and comfortable throughout the year. From installation and repairs
              to routine maintenance, our expert technicians are equipped to
              handle all your Washing Machine needs. No matter the brand or
              model, we deliver fast, reliable, and affordable service.
            </p>
          </div>

          <div className="row row-cols-1 g-4 w-md-50 w-100 mx-auto">
            <div className="col">
              <a href="https://www.google.com/maps/place/Karaikudi,+Tamil+Nadu">
                <div className="card h-100">
                  <div className="card-body">
                    <span className="check-mark">
                      <img
                    ...
                    <h6 className="card-title">
                      Washing Machine Repair Service Centre in Karaikudi
                    </h6>
                  </div>
                </div>
              </a>
            ...
            <div className="col">
              <a href="https://www.google.com/maps/place/Aranthangi">
                <div className="card h-100">
                  <div className="card-body">
                    <span className="check-mark">
                      <img
                    ...
                    <h6 className="card-title">
                      Washing Machine Repair Service Centre in Aranthangi
                    </h6>
                  </div>
                </div>
              </a>
              ...
              <a href="https://www.google.com/maps/place/Karaikudi,+Tamil+Nadu">
                <div className="card h-100">
                  <div className="card-body">
                    ...
                    <h6 className="card-title">
                      Washing Machine Repair Service Centre in Kottayur
                    </h6>
                  </div>
                </div>
              </a>
              ...
              <a href="https://www.google.com/maps/place/Karaikudi,+Tamil+Nadu">
                <div className="card h-100">
                  <div className="card-body">
                    ...
                    <h6 className="card-title">
                      Washing Machine Repair Service Centre in Tirupathur
                    </h6>
                  </div>
                </div>
              </a>
              ...
              <a href="https://www.google.com/maps/place/Karaikudi,+Tamil+Nadu">
                <div className="card h-100">
                  <div className="card-body">
                    ...
                    <h6 className="card-title">
                      Washing Machine Repair Service Centre in Ariyakudi
                    </h6>
                  </div>
                </div>
              </a>
